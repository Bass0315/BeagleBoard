...
"""
step:
1/ Download Adafruit_Python_GPIO
2/ touch oled.txt
3/ Seeed_OLED_1.12.py / oled.txt and Adafruit_Python_GPIO must be in the same path.
"""
import os
import sys
...
""" 
# shell:
# python Seeed_OLED_1.12.py "60" "2" "SH1107G"

# sys.argv[1] : OLED IIC address
# sys.argv[2] : IIC bus
# sys.argv[3] : OLED IC (SSD1327 or SH1107G)
"""
