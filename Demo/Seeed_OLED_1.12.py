...
class oled():
    def __init__(self, address, iicbus, IC):
        ...
        self.oled_Device = I2C.Device(int(address), int(iicbus))
        self.Drive_IC = IC
    ...
    def oled_putString_xy(self, str_x, str_y, String) :           
        self.oled_setTextXY(str_x,str_y)
...
if __name__=="__main__":
    ...
    User_OLED = oled(sys.argv[2], sys.argv[3], sys.argv[4])
    User_OLED.oled_init()
  
    if sys.argv[1] == "display" :      
        x = int(sys.argv[5])
        y = int(sys.argv[6])
        User_OLED.oled_putString_xy( y,  x,  sys.argv[7])
        # User_OLED.oled_setTextXY(x, y)
        # User_OLED.oled_putString(sys.argv[7])
...
""" 
# shell:
# python OLED_Display_210813.py "display" "60" "2" "SH1107G" "0" "0" "Hello,world!!"
